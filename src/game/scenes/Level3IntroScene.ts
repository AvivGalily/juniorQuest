    ...
    const html = `
      ...
      ">
        <div style="
          ...
          font-weight:700;
        ">
          <span>${escapeHtml(t("level3Intro.appTitle"))}</span>
        ...
        ">
          ...
          ">
            ...
            <div style="direction:${direction};text-align:${textAlign};font-size:${smallFont}px;line-height:1.35;color:#475569;font-weight:700;overflow:hidden;">
              <div>${escapeHtml(t("level3Intro.from"))}</div>
              <div>${escapeHtml(t("level3Intro.to"))}</div>
            </div>
          </div>
          ...
          ">${escapeHtml(t("level3Intro.subject"))}</div>
          ...
          <div style="
            ...
            text-align:${textAlign};
          ">
            <p style="margin:0 0 ${Math.round(scaleY(6))}px 0;">${escapeHtml(t("level3Intro.body"))}</p>
            <div style="
              ...
              color:#0f172a;
              font-weight:800;
            ">${escapeHtml(t("level3Intro.instructions"))}</div>
          </div>
